...
var HistoryView = (function (_super) {
    ...
    function HistoryView(props) {
        ...
        _this.measurableCarousel = function () { return (
        // find the largest possible message size by forcing a width larger than the chat itself
        React.createElement(WrappedActivity, { ref: function (x) { return (_this.carouselActivity = x); }, activity: {
                type: 'message',
                id: '',
                from: { id: '' },
                attachmentLayout: 'carousel'
            }, format: null, fromMe: false, onClickActivity: null, onClickRetry: null, selected: false, showTimestamp: false, chatBotIconUrl: _this.props.chatBotIconUrl, userIconUrl: _this.props.userIconUrl },
            React.createElement("div", { style: { width: _this.largeWidth } }, "\u00A0"))); };
        return _this;
    }
    HistoryView.prototype.componentWillUpdate = function () {
        this.scrollToBottom =
            Math.abs(this.scrollMe.scrollHeight -
                this.scrollMe.scrollTop -
                this.scrollMe.offsetHeight) <= 1;
    };
    HistoryView.prototype.componentDidUpdate = function () {
        if (this.props.format.carouselMargin == undefined) {
            ...
            var maxContentWidth = this.carouselActivity.messageDiv.offsetParent
                .offsetWidth - paddedWidth;
    ...
    HistoryView.prototype.render = function () {
        ...
        if (this.props.size.width !== undefined) {
            if (this.props.format.carouselMargin === undefined) {
                ...
                content = this.props.activities.map(function (activity, index) { return (React.createElement(WrappedActivity, { format: _this.props.format, key: 'message' + index, activity: activity, showTimestamp: index === _this.props.activities.length - 1 ||
                        (index + 1 < _this.props.activities.length &&
                            suitableInterval(activity, _this.props.activities[index + 1])), selected: _this.props.isSelected(activity), fromMe: _this.props.isFromMe(activity), chatBotIconUrl: _this.props.chatBotIconUrl, userIconUrl: _this.props.userIconUrl, onClickActivity: _this.props.onClickActivity(activity), onClickRetry: function (e) {
                    ...
                    React.createElement(ActivityView_1.ActivityView, { format: _this.props.format, size: _this.props.size, activity: activity, onCardAction: function (type, value) {
                            return _this.doCardAction(type, value);
        ...
        return (React.createElement("div", { className: "wc-message-groups", ref: function (div) { return (_this.scrollMe = div || _this.scrollMe); } },
            React.createElement("div", { className: "wc-message-group-content", ref: function (div) {
                    if (div)
...
exports.History = react_redux_1.connect(function (state) { return ({
    ...
    setMeasurements: function (carouselMargin) { return ({
        type: 'Set_Measurements',
        carouselMargin: carouselMargin
    }); },
    onClickRetry: function (activity) { return ({
    ...
    isSelected: function (activity) {
        return activity === stateProps.selectedActivity;
    },
    onClickActivity: function (activity) {
        return stateProps.connectionSelectedActivity &&
            (function () { return stateProps.connectionSelectedActivity.next({ activity: activity }); });
    }
}); })(HistoryView);
...
var WrappedActivity = (function (_super) {
    ...
    WrappedActivity.prototype.render = function () {
        ...
        var imgUrl = this.props.fromMe
            ? this.props.userIconUrl
            : this.props.chatBotIconUrl;
